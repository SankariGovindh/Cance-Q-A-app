...
final class QuestionData: ObservableObject  {
    ...
    func create_keys_values() -> String {
        return "?user_id=" + user_id +
            "&title=" + question_title.replacingOccurrences(of: " ", with: "%20") +
        "&content=" + question_content.replacingOccurrences(of: " ", with: "%20") +
...
final class CommentData: ObservableObject  {
    ...
    func create_keys_values() -> String {
        ...
        "&content=" + comment_content.replacingOccurrences(of: " ", with: "%20") +
